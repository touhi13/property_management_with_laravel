              ...
              <div id="dynamic_field">
                <div class="row">
                    <div class="col-xs-2">
                        ...
                        <input type="text" class="form-control" id="" placeholder="Expense Title"name="expense_title[]">
                    </div>
                    <div class="col-xs-2">
                        <label for="">Expense Description</label>
                        <textarea class="form-control" name="expense_desc[]" rows="3" placeholder="Write..."></textarea>
                    </div>
                    <div class="col-xs-2">
                    ...
                    <div class="col-xs-2">
                        <button type="button" name="add" id="add" class="btn btn-primary btnmrgn">+</button>
                    </div>  
                </div>
            </div>
            </div>
