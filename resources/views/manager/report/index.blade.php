...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(array('route'=>'store','method'=>'POST', 'target'=>'_blank')) !!}
      ...
      {!! Form::selectYear('year', 2015, 2025, null, array('class'=>'form-control','placeholder'=>'Select One', 'id'=>'year')) !!}
    </div>


      <div class="form-group">
        <label for="">Month</label>
        {!! Form::selectMonth('month',null, array('class'=>'form-control','placeholder'=>'Select One', 'id'=>'month','disabled')) !!}
      </div> --}}
            </div>
            <!-- /.box-body -->
...
<script>
    $(document).ready(function () {
        ...
        $("#level_id").change(function () {
            var url = "{{URL::to('/')}}";
            $('#unit_id').empty();
            $('#unit_id').append('<option value="">Select One</option>');
            var id = $(this).val();
            var url = "{{URL::to('/')}}";
            //alert(id);
